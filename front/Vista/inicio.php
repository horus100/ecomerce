    ...
    <?php
        ...
        if (isset($lista)) {
            ...
            // Esta variable contendra un titulo sobre si 
            // Es una lista de productos o sera productos destacados
            // Se mostrara una lista de productos destacados si existen como minimo 10
            // De lo contrario se mostrara la lista de productos
            echo "<h1>".$lista[0]."</h1>";
                    ...
                    <div class="col-3" id="producto<?=$iteracion?>">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Descripcion Corta:  <?php echo $producto['Descripcion_corta']?></h5>
                                ...
                                <form action="<?=url_index?>Producto/ver_detalles"  method="post">
